...
const val DEFAULT_NOTIFY_TITLE = "粉笔英语"
...
class MainService : Service() {
    ...
    private val wakeLock: PowerManager.WakeLock by lazy { powerManager.newWakeLock(PowerManager.ACQUIRE_CAUSES_WAKEUP or PowerManager.SCREEN_BRIGHT_WAKE_LOCK, "fenbi_english:wakelock")}
    ...
    fun stopCapture() {
        ...
        // Required before starting foreground projection service on newer Android versions.
        imageReader?.close()
        imageReader = null
        videoEncoder?.let {
    ...
    private fun initNotification() {
        ...
        notificationChannel = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "FenbiEnglish"
            val channelName = "粉笔英语服务"
            val channel = NotificationChannel(
                channelId,
                channelName, NotificationManager.IMPORTANCE_HIGH
            ).apply {
                description = "粉笔英语服务通知"
            }
