...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Fenbi English network..."),
        ...
        ("install_tip", "Due to UAC, Fenbi English can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Fenbi English to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Fenbi English \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Fenbi English \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Fenbi English to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Fenbi English Input] service."),
        ...
        ("doc_mac_permission", "https://www.fenbi.com/"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Fenbi English application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Fenbi English \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Fenbi English \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Fenbi English."),
        ...
        ("verify_fenbi_english_password_tip", "Verify Fenbi English password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Fenbi English and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_fenbi_english_server_pro_to_{}_tip", "Please upgrade Fenbi English Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://www.fenbi.com/"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Fenbi English from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Fenbi English"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Fenbi English window is open"),
        ...
        ("floating_window_tip", "It helps to keep Fenbi English background service"),
        ...
        ("upgrade_remote_fenbi_english_client_to_{}_tip", "Please upgrade the Fenbi English client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Fenbi English verifies the server certificate for protocols using TLS.\nWith this option enabled, Fenbi English will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Fenbi English will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Fenbi English server OSS doesn't include this feature."),
